...
// ─── Config ──────────────────────────────────────────────────
// Skip this suite unless a dev server is running (RUN_E2E=1 npx jest)
...
describeE2E('Step 1: analyze-open (Haiku)', () => {
...
describeE2E('Step 2: generate-chips', () => {
...
describeE2E('Step 3: safety-followup', () => {
...
describeE2E('Step 5: save-result (Airtable)', () => {
...
describeE2E('Step 6: notify-report (Email)', () => {
...
describeE2E('Full Pipeline E2E (KO Female 20s → Brightening)', () => {
...
describeE2E('Multi-language: analyze-open across 3 languages', () => {
  const scenarios = [
