...
const THANK_YOU_TEXT: Record<SurveyLang, {
  ...
  KO: {
    ...
    message_template: '{name}님, 분석이 완료되면 안내해 드리겠습니다.',
    what_next_title: '앞으로의 과정',
    what_next_items: [
      'AI가 80개 이상의 임상 프로토콜을 분석합니다 (약 3-5분)',
      '맞춤 시술 리포트가 자동 생성됩니다',
      '완료되면 입력하신 연락처로 안내해 드립니다',
    ],
  ...
  EN: {
    ...
    message_template: '{name}, we\'ll notify you when your analysis is ready.',
    ...
    what_next_items: [
      ...
      'We\'ll reach out to your provided contact when ready',
    ],
  ...
  'ZH-CN': {
    ...
    message_template: '{name}，分析完成后我们会通知您。',
