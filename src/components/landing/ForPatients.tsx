...
export default function ForPatients({ language = 'EN', onStartSurvey }: ForPatientsProps) {
    ...
    return (
        <section id="signup" className="py-24 bg-[#050505] relative overflow-hidden">
            {/* Background glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-cyan-600/5 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400">{t.cards.report.desc}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400">{t.cards.vault.desc}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400">{t.cards.care.desc}</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="w-full max-w-md bg-[#111111] border border-white/5 rounded-2xl p-8 shadow-2xl relative overflow-hidden group hover:border-cyan-500/30 transition-all duration-500">
                        {/* Glow effect */}
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-3 mb-8">
                                {[
                                    language === 'KO' ? '5분 설문 응답' : language === 'JP' ? '5분アンケート回答' : language === 'CN' ? '5分钟问卷' : '5-min survey',
                            ...
                            <button
                                ...
                                className="w-full group/btn flex items-center justify-center gap-3 px-6 py-4 bg-cyan-500 hover:bg-cyan-400 text-black rounded-xl font-bold text-lg transition-all hover:scale-[1.02] shadow-lg shadow-cyan-900/30"
                            >
                                {SURVEY_CTA[language] || SURVEY_CTA['EN']}
                                <ArrowRight className="w-5 h-5 group-hover/btn:translate-x-1 transition-transform" />
                            </button>

                            <p className="text-center text-[10px] text-slate-500 mt-4 tracking-tighter">
