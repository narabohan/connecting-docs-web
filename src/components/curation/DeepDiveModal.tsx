        ...
        <>
            <AnimatePresence>
                ...
                >
                    ...
                    >
                        {/* Header */}
                        <div className="flex-none flex items-start sm:items-center justify-between p-6 sm:p-10 border-b border-white/5 bg-[#0a0a0f]">
                            <div className="space-y-3">
                                {cat.best_primary_indication && (
                                    <span className="inline-block px-3 py-1 text-[10px] font-black tracking-[0.4em] text-cyan-400 uppercase border border-cyan-400/30 rounded-full bg-cyan-400/10">
                                        {cat.best_primary_indication}
                                    </span>
                                )}
                                <h2 className="text-4xl sm:text-5xl text-white font-serif italic font-light tracking-wide">
                                    {cat.category_display_name}
                                </h2>
                            </div>
                            <button onClick={onClose} className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-white transition-colors border border-white/10 shrink-0">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                            ...
                            <section className="space-y-4">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl sm:text-2xl font-serif font-light text-white tracking-wide">
                                        {language === 'EN' ? 'Why This Treatment' : '적합 사유'}
                                    </h3>
                                </div>
                                <div className="bg-gradient-to-br from-cyan-950/20 to-transparent border border-cyan-500/20 rounded-3xl p-6 sm:p-10 space-y-6">
                                    <p className="text-[14px] leading-[1.9] text-cyan-50 font-light">
                                        {whyText}
                                    </p>
                                    {overallDirectionText && (
                            ...
                            {deviceAlternatives.length > 0 && (
                                <section className="space-y-6 pt-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-serif font-light text-white tracking-wide">
                                            {language === 'EN' ? 'Alternative Devices' : '동일 원리 · 대체 장비 옵션'}
                                        </h3>
                                    </div>
