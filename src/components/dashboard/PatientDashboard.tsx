...
import { Loader2, Plus, FileText, MessageSquare, TrendingUp, Calendar, Star } from 'lucide-react';
                                ...
                                >
                                    ...
                                    <div className="mt-4 pt-4 border-t border-white/5 flex gap-3">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white text-sm rounded-lg transition-colors flex-1"
                                        >
                                            View Report
                                        </button>
                                        <button
                                            onClick={(e) => { e.stopPropagation(); router.push('/feedback'); }}
                                            className="px-4 py-2 bg-[#00FFA0]/10 hover:bg-[#00FFA0]/20 text-[#00FFA0] border border-[#00FFA0]/30 text-sm rounded-lg transition-colors flex items-center justify-center gap-2 flex-1 shadow-[0_0_10px_rgba(0,255,160,0.1)]"
                                        >
