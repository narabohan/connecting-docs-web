  ...
  injectableRecommendations: [
    {
      ...
      categoryNameKo: '폴리뉴클레오타이드 (PN)',
      categoryNameEn: 'Polynucleotide (PN)',
      categoryReason: '손상된 세포를 근본적으로 재생하여 피부 탄력과 장벽 기능을 동시에 회복시킵니다.',
      matchScore: 88,
      downtimeDisplay: '1-2일',
      painLevel: 2 as const,
      priceTier: 3 as const,
      alternativeProducts: [
        { name: 'Rejuran S', oneLiner: '흉터 전용 PDRN — 더 높은 농도', matchScore: 75, downtimeDisplay: '2-3일', painLevel: 3 as const, priceTier: 3 as const },
        { name: 'LNDG (Lenisna)', oneLiner: '차세대 PN — 교차결합 PDRN', matchScore: 72, downtimeDisplay: '1-2일', painLevel: 2 as const, priceTier: 4 as const },
      ],
    },
    {
      rank: 2,
      ...
      categoryNameKo: '바이오스티뮬레이터',
      categoryNameEn: 'Biostimulator',
      categoryReason: 'PDLLA 콜라겐 유도로 자연스러운 볼륨감과 탄력을 동시에 회복합니다.',
      matchScore: 86,
      downtimeDisplay: '3-5일',
      painLevel: 3 as const,
      priceTier: 4 as const,
      alternativeProducts: [
        { name: 'Sculptra', oneLiner: 'PLLA 기반 — 글로벌 1위 바이오스티뮬레이터', matchScore: 82, downtimeDisplay: '3-5일', painLevel: 3 as const, priceTier: 4 as const },
      ],
    },
    {
      rank: 3,
      ...
      categoryNameKo: '보툴리눔 톡신',
      categoryNameEn: 'Botulinum Toxin',
      categoryReason: '교근 축소를 통한 V라인 효과와 표정 주름 개선에 가장 높은 근거 수준을 보유합니다.',
      matchScore: 95,
      downtimeDisplay: '없음',
      painLevel: 1 as const,
      priceTier: 2 as const,
      alternativeProducts: [
        { name: 'Xeomin', oneLiner: '순수 톡신 — 항체 형성 최소화', matchScore: 90, downtimeDisplay: '없음', painLevel: 1 as const, priceTier: 2 as const },
        { name: 'Dysport', oneLiner: '빠른 확산 — 넓은 영역 시술에 유리', matchScore: 88, downtimeDisplay: '없음', painLevel: 1 as const, priceTier: 2 as const },
      ],
    },
  ],
