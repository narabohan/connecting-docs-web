...
// Airtable doesn't allow field creation via the standard API without Enterprise.
// Instead, we will report back that fields might need creating. 
// However we will attempt to batch update existing records if the columns are there.
